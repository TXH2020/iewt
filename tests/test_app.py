...
from iewt.main import make_app, make_handlers
from iewt.settings import (
    get_app_settings, get_server_settings, max_body_size
)
from iewt.utils import to_str
from iewt.worker import clients
...
class TestAppBasic(TestAppBase):
    ...
    def test_app_with_correct_credentials_user_bar(self):
        ...
        # end - those just for testing iewt websocket stablity
